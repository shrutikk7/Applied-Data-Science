...
fun <- function(df,postalCode)
{
  ...
  cs1 = mean(df$Overall_Sat_H[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")], na.rm=T)
  ...
  # Tranquility:
  cs1 = mean(df$Tranquility_H[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")], na.rm=T)
  ...
  # Hotel Condition:
  cs1 = mean(df$Condition_Hotel_H[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")], na.rm=T)
 ...
 # Staff Cared:
 cs1 = mean(df$Staff_Cared_H[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")], na.rm=T)
 ...
 print(paste("Current Staff Cared: ",cs2))
  ...
  b1=  (df$Business.Center_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  #,df$Conference_PL
  #
  b1=  (df$Conference_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  #,df$Convention_PL
  #
  b1=  (df$Convention_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  #
  #
  b1=  (df$Dry.Cleaning_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Elevators_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Fitness.Center_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Fitness.Trainer_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Golf_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Indoor.Corridors_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Laundry_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Limo.Service_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Mini.Bar_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Pool.Indoor_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Pool.Outdoor_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Regency.Grand.Club_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Resort_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Restaurant_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Self.Parking_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Shuttle.Service_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Ski_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
  ...
  b1=  (df$Valet.Parking_PL[(df$Postal.Code_PL==10036) & (df$Brand_PL=="Hyatt")])
  if( length(b1[b1=="Y"])>length(b1[b1=="N"]) )
  {b1<-c("Y")}
  if(length(b1[b1=="Y"])<length(b1[b1=="N"]))
  {b1<-c("N")}
...
nydf <- data.frame(c("Overall Satisfaction","Tranquility","Hotel Condition","Customer Service","Staff Cared")
                   ,c(9.04,8.85,9.31,9.25,9.04)
                   ,c(8.84,8.24,8.60,8.84,8.41)
)

colnames(nydf) <- c("Rating","Desired","Current")



melteddf = melt(nydf, id = "Rating")
